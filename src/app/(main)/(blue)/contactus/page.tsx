    ...
    <div className="flex min-h-screen items-center justify-center bg-[#F0F5FE] px-4 py-12">
      ...
      >
        ...
        <p className="mb-8 text-center text-gray-600">
          ...
          soon.</p> <p className="mb-6 text-center text-2xl font-bold text-[#0000EE]"> <a href="https://calendly.com/ichras_com/exploratory-meeting">Click here to book a meeting</a>
        </p>
